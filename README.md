...
### Pokestop icons
  - pokestop: `<lure id**>[_i][_d][_q{with_ar}][_ar].png` ( `_i` grunt invasion active, `_d` display type invasion active, `_q` quest active, `_ar` ar eligible ) images from invasion and reward folder can be used as overlay
